...
export function Chart({ type, data, options, width, height }: ChartProps) {
  ...
  switch (type) {
    ...
    case "scatter":
      return <Scatter data={data} options={chartOptions} width={width} height={height} />
    case "bubble":
      return <Bubble data={data} options={chartOptions} width={width} height={height} />
    case "polarArea":
      return <PolarArea data={data} options={chartOptions} width={width} height={height} />
    case "radar":
      return <Radar data={data} options={chartOptions} width={width} height={height} />
    default:
      return <Line data={data} options={chartOptions} width={width} height={height} />
  }
}
